...
paramList[0] = [4.9319*GHz-50*MHz/2, 4.9319*GHz+50*MHz/2, 2001, -10, -10, 1, 100, 'Temperature Sweep Soumya (500mK)']
#############################################################
...
for param in paramList:
	...
	# index_count = 0
		for index_count in range(len(power_list)):
			power = power_list[index_count]
			print index_count
			index_count+=1
			if power_points == 0:
				index_count-=1
