...
## 
center = 4.4449832*GHz
span = 100*kHz

start_freq = center - span/2.0 # 6.148908*GHz
stop_freq = center + span/2.0 # 6.153908*GHz
power = -28   # 2dB in cable, 6 dB in dir coup. and then blue cable input
num_points=1001
if_bw = 200
 
# pump
pump_start = center - 29*MHz
pump_stop = center - 33*MHz
pump_points = 401
pump_power = 0
