...
def generate_meta_file():
    ...
    metafile.write('#outer loop\n%s\n%s\n%s\n%s\n'%
            (DG_drive_power_numpoint, DG_drive_stop_power, DG_drive_start_power, 'V'))
...
# DG sweep parameters
dg_freq= 6.601302*MHz
DG_drive_start_power = 1
DG_drive_stop_power = 10 #0 dBm extra
DG_drive_power_numpoint = 10
...
dg.write(':SOUR1:VOLT %f'%DG_drive_start_power)
...
DG_drive_power_array = np.linspace(DG_drive_start_power, DG_drive_stop_power, DG_drive_power_numpoint)
...
for DG_div_power in DG_drive_power_array:
