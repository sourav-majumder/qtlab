...
def awg_program(gap, ph = ph):
    ...
    wave w_join = join(w_gauss ,w_zeros, w_gauss);
    //Cut the sin wave as the envelope length.
    wave w_cut1 = cut(w1, 0, 255+gap);
    wave w_cut2 = cut(w2, 0, 255+gap);
...
outermost_start = 7.05775*GHz
outermost_stop  = 7.05375*GHz  # One more than the end point you 
outermost_len  = 1
