...
def awg_program():
    ...
    wave w1 = sine(64*1000, 0.9, phase, 6*1000);
    wave w2 = sine(64*1000, 0.9, 0, 6*1000);
    //Define the envelope.
    ...
    wave w_cut1 = cut(w1, 0, 64+64+len);
    wave w_cut2 = cut(w2, 0, 64+64+len);
