...
'''
Attenuator used total 30dBm
Two room temp amplifiers used each 30 dBm
one dc block before vna port 2
...
paramList[0] =     [6.636667*GHz,  6.736667*GHz,  601,         0,            -50,          2,             100,    'power_sweep_qubit']
#############################################################
