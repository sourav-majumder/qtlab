...
path_gr = r'D:\data\20201221\145146_Dimon_dark_ground'
...
X_gr, _ = rotate(X_gr, Y_gr, zeros = (850,999), steady = (620,760))



path_sat = r'D:\data\20201221\152012_Dimon_dark_saturation'
# print path+path[16:]+r'.dat'
...
X_sat, _ = rotate(X_sat, Y_sat, zeros = (850,999), steady = (620,720))



path = r'D:\data\20201221\132531_Dimon_dark_rabi_long'
# print path+path[16:]+r'.dat'
...
X, _ = rotate(X, Y, zeros = (850,999), steady = (620,720))
...
def tau_fit(ydata, t ,plot=True):
	...
	lmfit_params.add('Tau', value=10e-6, min = 1e-6)
	lmfit_params.add('Norm', value=0.5, min = 0.5)
	lmfit_params.add('Rf', value=3.07e6)
...
#np.save(r'D:\data\20200305\123509_rabi_ssb_long\pop_test',pop)
