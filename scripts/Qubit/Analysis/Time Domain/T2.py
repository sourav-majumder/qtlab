...
path_gr = r'D:\data\20201220\173303_Dimon_ground'
...
X_gr, _ = rotate(X_gr, Y_gr, zeros = (850,999), steady = (620,720))



path_sat = r'D:\data\20201220\172947_Dimon_saturation'
# print path+path[16:]+r'.dat'
...
path = r'D:\data\20201220\220923_t2_dimon_with_ssb_phase_corrected3'
# print path+path[16:]+r'.dat'
...
# pop = full_pop(time, X, left, right, ground=gr, excited=sat, order=8)
# plt.plot(delay/1e-6, pop)
# plt.show()

tau = tau_fit(pop, delay)[-2]
print(tau/1e-6)
