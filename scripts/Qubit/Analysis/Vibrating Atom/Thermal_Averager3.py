...
path = r'D:\data\20191017\142443_-11.0_30_Volt_thermal_motion_amplification'
#data_name = path+path[16:]+r'.dat'
data_name=glob(path+r'\\*Volt_thermal_motion_amplification.dat')

for files in data_name:
    _, fr, pw_dBm1, pw_dBm2  = np.loadtxt(files, unpack=True, skiprows = 22)
    ...
    file = open(files[:-4]+'_lin_avg_red.dat', 'w+')
    ...
    file = open(files[:-4]+'_lin_avg_blue.dat', 'w+')
