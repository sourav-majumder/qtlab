...
num_points = 201
power = -30 ## (30 db physical attn outside)
if_bw= 50

start_current = 196.7e-3
stop_current = 196.9e-3
current_points = 21

#############################################################
start_freq = 6.1*GHz#center-span/2
stop_freq =  6.3*GHz#center+span/2
