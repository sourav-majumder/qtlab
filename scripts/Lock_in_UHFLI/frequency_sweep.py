...
out_channel = 0
out_mixer_channel = zutil.default_output_mixer_channel(props)
in_channel = 0
demod_index = 0
osc_index = 0
demod_rate = 10e3
...
sweeper.set('sweep/start', 4e6)
sweeper.set('sweep/stop', 50e6)
...
# Specify linear spacing for the values in the sweep interval.
